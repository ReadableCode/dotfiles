...
# old, so without this block go would exist but nothing would find it.
...
# Only load NVM in interactive shells (prevents vscode-server from picking up wrong Node)
if [[ $- == *i* ]]; then
